...
In this analysis supplement, we follow the main structure of the preregistration on OSF (https://osf.io/sd58n/), presenting first each preregistered analysis and its result followed by alternative, exploratory analyses and their results.
...
# Uncomment the following code to run models when knitting for the first time
# Models will be automatically saved to ./output/ folder
# [MODELS]
...
We compared the models with 2 and 3 source audience categories using Bayes' Factors. For the model of protest-related words, the BF was `r round(bf_prot,2)`, slightly favoring the 2-category model. For the model of police-related words, the BF was `r round(bf_pol,2)`, also favoring the 2-category model.
...
Comparing the models with 2 and 3 source audience categories using Bayes' Factors, we see that the BF was `r round(bf_prot_neg,2)`, again favoring the 2-category model.
...
#                  family='bernoulli', save_all_pars = T)
# 
# saveRDS(m_passive.kill2,
#         './output/passive_kill2.RDS')
...
#               family='bernoulli', save_all_pars = T)
# saveRDS(m_inn,
#         './output/innocence.RDS')
# saveRDS(m_inn2,
#         './output/innocence2.RDS')
